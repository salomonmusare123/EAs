...
void OnTick()
  ...
  if(currenttimestamp!=timestamplast){Print("-----------------------");timestamplast = currenttimestamp ; previous_pips = pips; psell = len ; pbuy = lenb;
      ...
      if (pips>30){lot = MathRound( lot *multiplier ) ; trade.Sell(lot/100, NULL , NULL, NULL) ; } ;     
      if (pips<-30){lotb = MathRound( lotb *multiplier ); trade.Buy(lotb/100, NULL , NULL, NULL) ;}
