...
CTrade trade;double previous_OP;int psell ; int pbuy ;int counter  = 0;int previous_pips= 0 ; double current_OP; input double multiplier = 1.6; input int minilot = 2; input int minilotb = 2; double lot = minilot ; double lotb = minilot;//1.04293 
...
void OnStart(  ){trade.Buy(lotb/100, NULL , NULL, NULL) ;  trade.Sell(lot/100, NULL , NULL, NULL) ;  Print("@@@@@@@@@@@@@@ in startg");};
void OnTick()
  {
